...
fromAt: "2025-07-05"
toAt: null
link: https://ondo-japan.com/
position:
  - フルスタックエンジニア
description: 動画配信プラットフォームOWNEDの開発。マルチテナントのB2B動画配信基盤で、文字起こしパイプラインやRAGチャットなど、AIまわりはほぼ自分が実装。
---

動画配信プラットフォームのOWNEDを開発しています。マルチテナント構成のB2Bサービスで、全体管理者、クライアント管理者、視聴者の3ロールがあり、クライアント企業ごとにテナントを提供する形です。文字起こしやRAGチャットなど、AIまわりはほぼ自分が作りました。インフラや認証などの基盤も担当しています。
